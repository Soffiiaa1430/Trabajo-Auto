...
public class ejer8 {
	...
	/*
	 * Crea un programa que permita a un profesor registrar las notas de sus estudiantes.Utiliza un HashMap donde las claves sean 
	 * los nombres de los estudiantes y los valores sean las notas correspondientes. El programa debe permitir al profesor agregar estudiantes 
	 * y asignar sus notas, así como también consultar la nota de un estudiante específico.
	 */
